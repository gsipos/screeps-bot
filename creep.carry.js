...
const energy = new creep_1.CreepJob('energy', '#ffaa00', 'energy', (c, t) => c.withdraw(t, RESOURCE_ENERGY), (c, t) => (c.carry.energy || 0) > 0 || t.energy === 0, c => util_1.findStructures(c.room, [STRUCTURE_CONTAINER, STRUCTURE_STORAGE]), creep_1.TargetSelectionPolicy.distance);
...
const fillCreeps = new creep_1.CreepJob('fillCreep', '#ee00aa', 'fill:creep', (c, t) => c.transfer(t, RESOURCE_ENERGY), (c, t) => t.carry.energy === t.carryCapacity || !!c.carry.energy, c => c.room.find(FIND_MY_CREEPS, { filter: (t) => 'miner carry'.includes(t.memory.role) }), creep_1.TargetSelectionPolicy.distance);
