...
class Profiler {
    ...
    print() {
        ...
        console.log(`PathStore  hit / miss: ${data_1.pathStore.storeHit} / ${data_1.pathStore.storeMiss} | Hit ratio: ${(data_1.pathStore.storeHit / (data_1.pathStore.storeHit + data_1.pathStore.storeMiss)).toFixed(2)}`);
    }
}
